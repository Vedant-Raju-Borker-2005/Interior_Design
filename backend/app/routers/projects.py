        ...
        "items": [
            {
                ...
                "product": {
                    ...
                    "room_type": it.product.room_type,
                    "price": it.product.price,
                    "thumbnail_url": it.product.thumbnail_url,
                    "variants": it.product.variants or {},
                    "images": it.product.images or [],
                    "primary_material": it.product.primary_material,
                    "width": it.product.width,
                    "height": it.product.height,
                    "depth": it.product.depth,
                    "weight": it.product.weight,
                    "weight_capacity": it.product.weight_capacity,
                    "style": it.product.style,
                    "finish": it.product.finish,
                    "mounting_type": it.product.mounting_type,
                    "assembly_required": it.product.assembly_required,
                    "suitable_room": it.product.suitable_room,
